...
class layout_Default_html_35efc41d7a9552d38cf8bdde9cc1543270b9209e extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output258 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('data.header', $array259)]);
...
$array255 = array();
$array256 = array (
);$array255['0'] = $renderingContext->getVariableProvider()->getByPath('data.header', $array256);
...
$output0 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments253, $renderChildrenClosure254, $renderingContext);
...
$arguments260['section'] = 'Main';
// Rendering Boolean node
// Rendering Array
$array262 = array();
$array262['0'] = 'true';

$expression263 = function($context) {return TRUE;};
$arguments260['optional'] = TYPO3Fluid\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean(
					$expression263(
...
$output0 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments260, $renderChildrenClosure261, $renderingContext);
...
$arguments269['partial'] = NULL;
$arguments269['delegate'] = NULL;
$arguments269['renderable'] = NULL;
$arguments269['arguments'] = array (
);
$arguments269['optional'] = false;
$arguments269['default'] = NULL;
$arguments269['contentAs'] = NULL;
$arguments269['debug'] = true;
$arguments269['partial'] = 'Footer/All';
$arguments269['arguments'] = $renderingContext->getVariableProvider()->getAll();

$output268 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments269, $renderChildrenClosure270, $renderingContext);
...
$output0 .= TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments264, $renderChildrenClosure265, $renderingContext);
