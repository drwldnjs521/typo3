...
class partial_Media_Type_Image_f7dfc6ed17a5a0573f3e98507615119f88b9886c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array141 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.description', $array141)]);
};
$arguments139 = array();
...
$output138 .= TYPO3\CMS\Fluid\ViewHelpers\Format\Nl2brViewHelper::renderStatic($arguments139, $renderChildrenClosure140, $renderingContext);
